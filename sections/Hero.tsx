...
export default function Hero () {
    return (
        <section className="hero-section">
            <div className="main hero-inner bg-center bg-cover bg-no-repeat" style={{backgroundImage: "url('/hero-bg.png')"}} id="header">
                ...
                <motion.div className="hero-visual" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.22 }}>
                    <div className="hero-avatar-container">
                        ...
                        <Image src={OutLineImage} alt="Yuyu - Full-stack Designer" className="hero-avatar-border" width={880} height={880} />
                ...
                <div className="hero-bottom-left">
                    ...
                    <a href="https://yuyu.nyc3.cdn.digitaloceanspaces.com/docs/Yusuf%20Odukoya%20-%20Corporate%20Overview%20Document%20.pdf" target="_blank" rel="noopener" download className="btn-text hero-profile-link">
                ...
                <a href="start-a-project/" className="btn btn-primary hero-cta">
